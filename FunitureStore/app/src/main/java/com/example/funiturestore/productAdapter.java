...
public class productAdapter extends RecyclerView.Adapter<productAdapter.ViewHolder> {
    private ArrayList<com.example.funiturestore.Product> productArrayList;
    private Context context;
    int lastPos = -1;
    private ProductClickInterface productClickInterface;

    public productAdapter(ArrayList<com.example.funiturestore.Product> productArrayList, Context context, ProductClickInterface productClickInterface) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        com.example.funiturestore.Product product = productArrayList.get(position);
